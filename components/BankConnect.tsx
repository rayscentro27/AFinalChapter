    ...
    setTimeout(() => {
      ...
      const autoFinancials: FinancialSpreading = {
        ...
        months: [
          ...
          { month: 'Oct 2023', revenue: 21200, expenses: 15500, endingBalance: 11200, nsfCount: 2, negativeDays: 1 },
          { month: 'Sep 2023', revenue: 19800, expenses: 14000, endingBalance: 9100, nsfCount: 0, negativeDays: 0 }, 
        ]
      };
