      ...
      GRANTS_SHORTLIST = 'GRANTS_SHORTLIST',
      GRANTS_DRAFTS = 'GRANTS_DRAFTS',
      GRANTS_SUBMISSIONS = 'GRANTS_SUBMISSIONS',
      GRANTS_TRACKING = 'GRANTS_TRACKING',
    FUNDING_OVERVIEW = 'FUNDING_OVERVIEW',
    FUNDING_PROGRAMS = 'FUNDING_PROGRAMS',
    FUNDING_QUALIFICATION = 'FUNDING_QUALIFICATION',
    FUNDING_APPLICATIONS = 'FUNDING_APPLICATIONS',
    FUNDING_REQUIRED_DOCS = 'FUNDING_REQUIRED_DOCS',
...
export enum ViewMode {
  ...
  FIRST_FIVE_MINUTE_FLOW = 'FIRST_FIVE_MINUTE_FLOW',
  CLIENT_ONBOARDING = 'CLIENT_ONBOARDING',
  CLIENT_DASHBOARD = 'CLIENT_DASHBOARD',
  CLIENT_DETAIL = 'CLIENT_DETAIL',
  CLIENT_DETAIL_OVERVIEW = 'CLIENT_DETAIL_OVERVIEW',
  CLIENT_DETAIL_FUNDING = 'CLIENT_DETAIL_FUNDING',
  CLIENT_DETAIL_DOCUMENTS = 'CLIENT_DETAIL_DOCUMENTS',
  CLIENT_DETAIL_CREDIT_PROFILE = 'CLIENT_DETAIL_CREDIT_PROFILE',
  CLIENT_DETAIL_ACTIVITY = 'CLIENT_DETAIL_ACTIVITY',
  CLIENT_DETAIL_ALERTS = 'CLIENT_DETAIL_ALERTS',
  // ...existing values...
}
...
export enum ViewMode {
  ...
  PORTAL_FUNDING = 'PORTAL_FUNDING',
  PORTAL_BUSINESS = 'PORTAL_BUSINESS',
  ...
  ADMIN_CEO_BRIEFING = 'ADMIN_CEO_BRIEFING',
  ADMIN_SUPER_ADMIN_COMMAND_CENTER = 'ADMIN_SUPER_ADMIN_COMMAND_CENTER',
  ADMIN_SOURCE_REGISTRY = 'ADMIN_SOURCE_REGISTRY',
  ADMIN_COMMAND_INBOX = 'ADMIN_COMMAND_INBOX',
  ADMIN_MONETIZATION_OPPORTUNITIES = 'ADMIN_MONETIZATION_OPPORTUNITIES',
  ADMIN_AUTONOMOUS_EXPANSION = 'ADMIN_AUTONOMOUS_EXPANSION',
  ADMIN_ORGANIZATION_DASHBOARD = 'ADMIN_ORGANIZATION_DASHBOARD',
  ADMIN_FUNNEL_CONTROL_CENTER = 'ADMIN_FUNNEL_CONTROL_CENTER',
  ADMIN_WHITE_LABEL_SETTINGS = 'ADMIN_WHITE_LABEL_SETTINGS',
  ADMIN_EXECUTIVE_DASHBOARD = 'ADMIN_EXECUTIVE_DASHBOARD',
  ADMIN_NEXUS_ONE = 'ADMIN_NEXUS_ONE',
  ADMIN_CREDENTIALS = 'ADMIN_CREDENTIALS',
  ADMIN_DEAL_ESCALATIONS = 'ADMIN_DEAL_ESCALATIONS',
